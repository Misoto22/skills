...
- **[synastry](plugins/astrology/skills/synastry/SKILL.md)** (`/astrology:synastry`) — validates two supplied birth records and writes one privacy-minimal, uncertainty-aware JSON v2 chart artifact with recorded backend provenance; exact records can include house overlays, then it starts the separate reading automatically.
