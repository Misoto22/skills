...
if [ -n "$SKILL" ]; then
	"$VENV_DIR/bin/python" "$REPO_DIR/scripts/run-evals.py" --run "$SKILL"
	"$VENV_DIR/bin/python" "$REPO_DIR/scripts/run-evals.py" --run-behaviors "$SKILL"
else
	"$VENV_DIR/bin/python" "$REPO_DIR/scripts/run-evals.py" --run
	"$VENV_DIR/bin/python" "$REPO_DIR/scripts/run-evals.py" --run-behaviors
fi
