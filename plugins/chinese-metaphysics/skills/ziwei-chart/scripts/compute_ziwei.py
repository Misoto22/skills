#!/usr/bin/env python3
"""Place one Zi Wei Dou Shu chart and write canonical JSON plus data-only Markdown."""
...
from ziwei.engine import build_chart
from ziwei.palaces import ZiweiError
...
def main(
    ...
    *,
    ...
    try:
        ...
        json_path, markdown_path = write_artifact_pair(envelope, args.out, kind="ziwei")
    except (
        ArtifactError,
        BirthDataError,
        CalendarError,
